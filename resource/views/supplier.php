...
$supplier_query = "SELECT supplier_id, supplier_name, contact_info, address, status, createdbyid, createdate, updatedbyid, updatedate 
                   FROM Supplier 
                   ORDER BY supplier_id " . ($order_by === 'desc' ? 'DESC' : 'ASC');
...
function toggleAddSupplierForm() {
    ...
    if (form.style.display === "none" || form.style.display === "") {
        ...
        lien.innerHTML = '<i class="fa fa-times"></i> Close';

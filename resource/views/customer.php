...
if (isset($_SESSION['search_results'])) {
    ...
    $query = "SELECT i.customer_id, 
                    ...
                    i.updatedbyid,
                    i.updatedate
                    FROM Customer i JOIN customer_type c ON i.type_id = c.type_id";
    $result = $conn->query($query);
    $customers = $result->fetch_all(MYSQLI_ASSOC);
    $member = "SELECT type_id, type_name FROM customer_type";
    ...
    <form method="POST" action="../../handlers/searchcustomer.php">
        <div class="search-container">
            ...
            <button type="submit" class="btn btn-success"
                onclick="window.location.href=window.location.href">SEARCH</button>
...
<div class="customer-table">
    <div class="table-controls">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">CREATE <i
                ...
                <form action="../../handlers/updatecustomer.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="is_member" class="form-control" required>
                            ...
                            <option value="0" <?php echo $row['is_member'] == 0 ? 'selected' : ''; ?>>Non-Member
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">

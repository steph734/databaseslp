...
?>
    ...
    <style>
        ...
        .custom-select {
            ...
            cursor: pointer;
            width: 50px; /* Fixed width for the select box */
        }

        .select2-container {
            width: 50px !important; /* Fixed width for the container */
        }
        ...
        .select2-selection__arrow {
            display: none; /* Hide default Select2 arrow since Font Awesome is used */
        }
        ...
        .select2-dropdown {
            width: 200px !important; /* Wider dropdown for full text */
            background-color: white;
            border: 1px solid #ccc;
            border-radius: 5px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            z-index: 1050; /* Ensure it floats above other elements */
        }
        ...
        @media (max-width: 768px) {
            ...
            .custom-select,
            .select2-container {
                width: 50px !important; /* Maintain size on smaller screens */
            }
        }
        ...
        @media (max-width: 500px) {
            ...
            .custom-select,
            .select2-container {
                width: 50px !important; /* Maintain size on smallest screens */
            }
        }
    </style>
        ...
        <div class="products-table">
            <div class="table-controls">
                ...
                <select id="orderBy" class="custom-select" onchange="applyTableFilters()">
                    ...
                    <option value="received_date|DESC" data-icon="fa-solid fa-arrow-down-long">Received Date (Newest)</option>
                ...
                <table class="table table-striped">
                    ...
                    <tbody id="inventory-table-body">
                        ...
                        <tr>
                            ...
                            <td class="<?= $row['stock_level'] == 'Out of Stock' ? 'text-danger' : ($row['stock_level'] == 'Low Stock' ? 'text-warning' : ($row['stock_level'] == 'Reorder Needed' ? 'text-primary' : 'text-success')) ?>">
                                <?= $row['stock_level'] ?>
                            </td>
            ...
            <div class="modal-content">
                ...
                <form action="../../handlers/editinventory_handler.php" method="POST" id="editInventoryForm">
                    <div class="modal-body">
                        ...
                        <p id="damageStockValidation" class="validation-message">Damage stock cannot exceed stock quantity.</p>
